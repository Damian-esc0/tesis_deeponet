...
![a)Posición del brazo derecho (vista superior). La linea horizontal II indica el nivel de la figura c). \qquad b)Posición del brazo derecho (vista lateral). \qquad c)Sección transverla anatómica del antebrazo en el nivel II. Fuente:@pennes1948](images/pennes_art.png){#fig-pennes_art fig-align="center" width="500"}
