...
```{python}
#| label: fig-poisson-ejemplo
#| fig-cap: Soluciones halladas por la red neuronal, en la parte superior las funciones arbitrarias $f(x)$, mientras que en la parte inferior está su solución $u(x)$, el color representa la relación *término-solución*.
