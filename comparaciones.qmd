...
Esta sección presenta un análisis cualitativo de los resultados mediante la comparación directa entre las predicciones del modelo, las soluciones reportadas en el estudio de @medical_rep y las obtenidas mediante el método de Crank Nickolson y la solución analítica. La visualización paralela permite evaluar:
...
El siguiente código utiliza los archivos csv de @lst-modelo-don y @lst-met-num para graficar una comparativa entre los tiempos de interés, las predicciones del modelo se encuentran en la parte superior mientras que las del método numérico en la parte inferior.
```{python}
...
El siguiente código utiliza los archivos csv de @lst-modelo-don y @lst-sol-ana para graficar una comparativa entre los tiempos de interés, las predicciones del modelo se encuentran en la parte superior mientras que las de la solución analítica en la parte inferior.
```{python}
...
fig.text(0.5, 0.92, "Predicciones modelo DON", 
        ha='center', va='center', fontsize=14,fontweight='bold')
fig.text(0.5, 0.56, "Predicciones de la Sol. analítica",
        ha='center', va='center', fontsize=14, fontweight='bold')
