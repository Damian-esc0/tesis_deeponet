...
Esta sección presenta un análisis cualitativo de los resultados mediante la comparación directa entre las predicciones del modelo, las soluciones reportadas en el estudio de @medical_rep, así como las obtenidas mediante el método de Crank Nicolson y la solución analítica. La visualización paralela permite evaluar:
...
### Modelo contra el método de Crank-Nicolson {#sec-val-cuant-Cr-Nc}
