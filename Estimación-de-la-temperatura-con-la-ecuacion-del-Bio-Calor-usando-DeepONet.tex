...
\caption{\label{fig-pennes_art}a)Posición del brazo derecho (vista
superior). La linea horizontal II indica el nivel de la figura
c).\textbackslash{} b)Posición del brazo derecho (vista
lateral).\textbackslash{} c)Sección transverla anatómica del antebrazo
en el nivel II. Fuente:Pennes (\citeproc{ref-pennes1948}{1948})}
...
- \(\rho, c\): Densidad (kg/m³) y calor específico (J/kg·°C) del
tejido.\\
...
- \(Q = q_m + q_p\): Fuente de calor (\(W/m^3\)), incluye metabolismo
(\(q_m\)) y aporte externo (\(q_p\)).
...
\section{Tabla de nomenclatura}\label{tabla-de-nomenclatura}
...
multiplica, Instituto Nacional del Cáncer
(\citeproc{ref-nci2021}{2021}).}
...
enteramente en la librería Deepxde creada por Lu et~al.
...
\begin{verbatim}
2025-05-19 23:48:10.558682: I tensorflow/tsl/cuda/cudart_stub.cc:28] Could not find cuda drivers on your machine, GPU will not be used.
2025-05-19 23:48:10.610332: I tensorflow/tsl/cuda/cudart_stub.cc:28] Could not find cuda drivers on your machine, GPU will not be used.
2025-05-19 23:48:10.611088: I tensorflow/core/platform/cpu_feature_guard.cc:182] This TensorFlow binary is optimized to use available CPU instructions in performance-critical operations.
To enable the following instructions: AVX2 FMA, in other operations, rebuild TensorFlow with the appropriate compiler flags.
2025-05-19 23:48:11.410503: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
...
\begin{verbatim}
'compile' took 14.625464 s
\end{verbatim}

\begin{verbatim}
2025-05-19 23:48:27.572878: I tensorflow/compiler/mlir/mlir_graph_optimization_pass.cc:375] MLIR V1 optimization pass is not enabled
\end{verbatim}
...
'train' took 23.455316 s

Compiling model...
'compile' took 33.974093 s
