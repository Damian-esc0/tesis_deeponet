...
Las EDPs, al igual que las ecuaciones diferenciales ordinarias (EDOs), se clasifican en lineales y no lineales. De forma análoga a una EDO lineal, la variable dependiente y sus derivadas parciales en una EDP lineal se elevan únicamente a la primera potencia [@zill2008].
...
donde los coeficientes $A, B, C, \dots, G$ son funciones de $x$ e $y$. Cuando $G(x, y) = 0$, la @eq-LPDE se denomina **homogénea**; de lo contrario, es **no homogénea**. Por ejemplo, las ecuaciones lineales:
