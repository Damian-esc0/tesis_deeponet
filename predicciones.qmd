...
fig.write_image("images/fig-training_loss.png", width=800, height=600)
```
...
os.makedirs("images", exist_ok=True)
# Exportar imagen para PDF
fig.write_image("images/fig-test_loss.png", width=800, height=600)
```
